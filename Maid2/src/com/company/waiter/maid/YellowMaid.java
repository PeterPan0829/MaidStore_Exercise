 ...
 */
public class YellowMaid implements Waiter {
    private YellowMaid(){};
    private static YellowMaid instance;

    synchronized static public YellowMaid getInstance(){
        if (instance == null){
            return instance = new YellowMaid();
        }else {
            return instance;
        }
    }
    ...
    public YellowMaid(ClothingBuilder clothingBuilder){
