 ...
 */
public class BlueMaid implements Waiter{

    private BlueMaid(){};
    private static BlueMaid instance;

    synchronized public static BlueMaid getInstance(){
        if(instance == null){
            return instance = new BlueMaid();
        }else {
            return instance;
        }
    }
    ...
    public int price() {
        ...
        BlueMaid main = new BlueMaid(builder);
    ...
    public BlueMaid(ClothingBuilder clothingBuilder){
