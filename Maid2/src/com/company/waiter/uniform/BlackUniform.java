 ...
 */
public class BlackUniform implements Waiter{

    private BlackUniform(){};
    private static BlackUniform instance;

    synchronized static public BlackUniform getInstance(){
        if(instance == null){
            return instance = new BlackUniform();
        }else {
            return instance;
        }
    }
    ...
    public int price() {
        ...
        BlackUniform main = new BlackUniform(builder);
    ...
    public BlackUniform(ClothingBuilder clothingBuilder){
