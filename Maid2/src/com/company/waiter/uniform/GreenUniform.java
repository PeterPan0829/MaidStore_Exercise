package com.company.waiter.uniform;
 ...
 */
public class GreenUniform implements Waiter{

    private GreenUniform(){};
    private static GreenUniform insatnce;

    synchronized static public GreenUniform getInsatnce(){
        if(insatnce == null){
            return insatnce = new GreenUniform();
        }else {
            return insatnce;
        }
    }
    ...
    public int price() {
        ...
        GreenUniform main = new GreenUniform(builder);
    ...
    public GreenUniform(ClothingBuilder clothingBuilder){
